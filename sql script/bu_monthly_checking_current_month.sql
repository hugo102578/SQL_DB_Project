...
(
SELECT
  IBBI_STAGING."D_BU"."BU_CODE" AS "BU Code",
  IBBI_STAGING."D_BU_BRAND"."BU_BRAND_NAME" AS "BU Brand Name",
  IBBI_STAGING."D_IB_BRAND"."IB_BRAND_NAME" AS "IB Brand Name",
  IBBI_STAGING."D_SUPPLIER"."SUPPLIER_CODE" AS "BU Supplier Code",
  IBBI_STAGING."D_SUPPLIER"."SUPPLIER_NAME" AS "BU Supplier Name",
  IBBI_STAGING."D_MOTHER_CO"."MOTHER_CO_CODE" AS "Mother Company Code",
  IBBI_STAGING."D_MOTHER_CO"."MOTHER_CO_NAME" AS "Mother Company Name",
  ROW_NUMBER() 
