...
WHERE
		 ( "ITEM_MOTHER_CO_MAP"."SUPPLIER_ID"="D_SUPPLIER"."SUPPLIER_ID"  )
	AND  ( "ITEM_MOTHER_CO_MAP"."ITEM_ID" = "ITEM_SUPPLIER_MAP"."ITEM_ID"  
	AND  "ITEM_MOTHER_CO_MAP"."BU_ID" = "ITEM_SUPPLIER_MAP"."BU_ID"  
		AND  "ITEM_MOTHER_CO_MAP"."BU_BRAND_ID" = "ITEM_SUPPLIER_MAP"."BU_BRAND_ID"  
			AND  "ITEM_MOTHER_CO_MAP"."SUPPLIER_ID" = "ITEM_SUPPLIER_MAP"."SUPPLIER_ID"  )
	...
	AND  ( "ITEM_SUPPLIER_MAP"."BU_BRAND_ID"="D_BU_BRAND"."BU_BRAND_ID"  )
	AND  ( "ITEM_SUPPLIER_MAP"."ITEM_ID" = "D_ITEM_STS"."ITEM_ID"  
		AND  "ITEM_SUPPLIER_MAP"."TIME_MONTH_ID" = "D_ITEM_STS"."TIME_MONTH_ID"  
			AND  "ITEM_SUPPLIER_MAP"."BU_ID" = "D_ITEM_STS"."BU_ID"  )
